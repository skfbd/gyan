		...
		<div class="login-box-body">
			...
			<form action="../../index2.html" method="post">
				...
				<div class="row">
					...
					<!-- /.col -->
					<div class="col-xs-4">
						<a href="../../pages/adminViews/mainPage.jsp">Login</a>
						<!--   <button type="submit" class="btn btn-primary btn-block btn-flat" href="http://localhost:8080/Gyaan/pages/adminViews/mainPage.jsp">Sign In</button>
