...
<c:url var="urllogout" value="/Login/logout.htm" />
<header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>School Name</b>LTE</span>
        </a>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          ...
                          <img src="<c:url value="/dist/img/user4-128x128.jpg"/>" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                            Developers
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ...
                      <small>Member se Nov. 2012</small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
