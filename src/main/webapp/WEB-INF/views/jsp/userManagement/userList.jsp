...
<c:url  var="urlOrgSessionEdit" value="/academicSessionEdit.htm" />
<div data-options="region:'center',title:'Academic Session',iconCls:'icon-ok'">
		     ...
		     <table id="dg" class="easyui-datagrid" toolbar="#toolbar"
                ...
                <thead>
                    <tr> 
                        <th data-options="field:'onganizationName',align:'center'" width="80">Organization Name</th>
